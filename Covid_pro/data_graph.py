...
def index():
    ...
    return render_template('data_and_graph.html', posts=posts, plot1=lineplot1, plot2=lineplot2, plot3=pie_india, plot4=statewise_pie, plot5=statewise_bar)
...
def country_lineplot():
    ...
    data=[trace1]
    fig = go.Figure(data=data)
    fig.update_layout(template="plotly_dark", title_text='Timeseries showing the spread of corona virus in India')
...
def country_lineplot_rate():
    ...
    fig2.update_layout(template="plotly_dark", title_text='Timeseries showing the Rate of change of Spread of corona virus in India')
...
def pie_india_vs_world():
    ...
    fig3.update_layout(template="plotly_dark", title_text='Piechart showing the Distribution of cases in india compared to other countries',)
...
def statewise_piechart():
    ...
    fig4 = px.pie(df2, values='confirmed', names='state', title='Pie chart showing the distribution of the Spread', template='plotly_dark')
